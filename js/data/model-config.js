...
export const ASSET_VERSION = "20260917-eln2";
...
export const REGAL_PRESETS = Object.freeze({
  best: { bat: 13, batc: 0, gpsc: 42, gpsu: 42.5, delay: 3, mid: 28, k: 0.15, auto: false, xtx: 0, cens: 26, mcFloor: true, irm_lead: 3 },
  bind: { bat: 13, batc: 0, gpsc: 42, gpsu: 42.5, delay: 3, mid: 28, k: 0.15, auto: false, xtx: 0, cens: 26, mcFloor: true, irm_lead: 3 },
  nonbind: { bat: 13, batc: 0, gpsc: 42, gpsu: 42.5, delay: 3, mid: 28, k: 0.15, auto: false, xtx: 0, cens: 26, mcFloor: false, irm_lead: 3 },
...
export const DEFAULT_ELN = Object.freeze({
  ...
  gpsDurFav: 60, gpsDurInt: 37, gpsDurAdv: 0,
  gpsNonDurableGain: 1,
  gpsXtx: 13, batXtx: 12,
...
export const REGAL_UNCERTAINTY = Object.freeze({
  ...
  cens: { kind:"assumption_range",lo:0,hi:.50,sd:.09,source:"Independent OS-censoring sensitivity" },
